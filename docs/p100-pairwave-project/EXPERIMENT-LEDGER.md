...
| PairWave | Can two fixed pairs own alternating layers with one expert copy? | One-copy loader and lane-exact service are exact. Full PairFold scheduler remained replay-only. | [audit](archive/frontier/PAIRWAVE-AUDIT.md) |
